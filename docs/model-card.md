...
| Sequence model | none (frozen encoder) | bidirectional LSTM + additive attention pooling |
...
- `data/raw/synthetic_uk_transactions.csv` — 2,400+ generated, labelled,
  noisy UK transaction descriptions (seeded, deterministic).
